...
# Core Variables
$PolicyID = "CA204"
$DisplayName = "$PolicyID-AllApps:ManagedDevice-For:Internals-When:AnyNetwork"
...
$DeviceFilter = 'device.trustType -eq "AzureAD" -or device.trustType -eq "ServerAD" -or device.isCompliant -eq True -or device.deviceOwnership -eq "Company"'
